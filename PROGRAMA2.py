...
def get_queue_from_user():
    queue = Queue()
    CantNum = int(input("Cantidad de elementos para la cola, el número de letras de la palabra: "))
...
if __name__ == "__main__":
    ...
    print("La cola de las palabras original es:", queue.items)  #IMPRIME LA COLA ORIGINAL

    reverse_half_queue(queue)
    print("La palabra revertida:", queue.items) #NOS DA LA COLA REVERTIDA
